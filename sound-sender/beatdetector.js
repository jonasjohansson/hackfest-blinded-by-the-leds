...
(function() {
	...
	this.BeatDetector.prototype = {
		...
		isOnBeat: function() {
			...
			if (instantCounter > this.COLLECT_SIZE - 1 && this.historyBuffer.length > this.MAX_COLLECT_SIZE - 1) {
		...
		getBPMGuess: function() {
			...
			return { conservative: Math.round(60 / (guesses / counter)), all: Math.round(60 / (allGuesses / this.bpmTable.length)) };
		}
	};
}.call(stasilo));
